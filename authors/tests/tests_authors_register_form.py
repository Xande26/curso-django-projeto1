...
class AuthorRegisterFormIntegrationTest(DjangoTestCase):
    ...
    def test_password_ans_password_confirmation_are_equal(self):
        self.form_data['password'] = '@A123abc123'
    ...
    def test_send_get_request_to_registration_creat_view_returns_404(self):
        url = reverse('authors:register_create')
    ...
    def test_author_creat_login(self):
        url = reverse('authors:register_create')
        ...
        is_autenticater = self.client.login(
            username='testuser',
            password='@Bc123456',
        )
        self.assertTrue(is_autenticater)
